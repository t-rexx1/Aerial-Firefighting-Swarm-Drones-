...
class Simulation:
    ...
    def _compute_nozzle_positions(self, airplane, plane_right, count):
        ...
        base_positions[nozzle_idx == 1] += self.SPACING * plane_right
        base_positions[nozzle_idx == 2] -= self.SPACING * plane_right
        base_positions[nozzle_idx == 3] -= self.SPACING * airplane.dir
    ...
    def calculate_cost(self):
        ...
        return self.W_1 * (1 - N_hit / N_total) + self.W_2 * (1 - self.airplane.y0 / self.Y0_MAX)
